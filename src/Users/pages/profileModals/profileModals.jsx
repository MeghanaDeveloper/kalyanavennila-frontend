...
const ProfileModals = () => {
  ...
  return (
    <>
      {profileProgress !== 100 && profileModalOpen && (
        <>
          <div className="fixed inset-0 bg-opacity-60 backdrop-blur-sm flex justify-center items-center z-50 shadow-2xl  ">
            <div className="bg-white bg-opacity-60 rounded-lg p-10  min-h-[50vh] max-h-[90vh] min-w-[30vw] max-w-[80vw] md:max-w-[35vw] overflow-y-scroll scrollbar-hide relative border-4 border-primary ">
              <IoMdClose
                onClick={() => [setProfileModalOpen(false)]}
                className="absolute right-8  text-primary text-xl transition-effects"
              ></IoMdClose>

              <h2 className="text-5xl font-italian pt-9 font-bold text-primary text-center ">
